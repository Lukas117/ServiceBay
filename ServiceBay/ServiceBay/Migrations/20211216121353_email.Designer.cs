...
namespace ServiceBay.Migrations
{
    ...
    [Migration("20211216121353_email")]
    partial class email
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceBay.Dto.AddressForCreationDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AddressForCreationDto");
                });
            ...
            modelBuilder.Entity("ServiceBay.Dto.CityForCreationDto", b =>
                {
            ...
            modelBuilder.Entity("ServiceBay.Dto.PersonViewModel", b =>
                {
                    b.Property<int?>("addressDtoId")
                        .HasColumnType("int");

                    b.Property<string>("cityDtoZipcode")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ServiceBay.Dto.PersonViewModel", b =>
                {
                    b.HasOne("ServiceBay.Dto.AddressForCreationDto", "addressDto")
                        .WithMany()
                        .HasForeignKey("addressDtoId");

                    b.HasOne("ServiceBay.Dto.CityForCreationDto", "cityDto")
                        .WithMany()
                        .HasForeignKey("cityDtoZipcode");

                    b.HasOne("ServiceBay.Dto.PersonForCreationDto", "personDto")
                        .WithMany()
                        .HasForeignKey("personDtoId");

                    b.Navigation("addressDto");

                    b.Navigation("cityDto");
